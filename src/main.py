# Code will iterate through directory of files in TICO-19 format
# Translates all sentences English->X by Google and Microsoft if covered by API
# Adds translations from generic Tigrinya dialect to specific Tigrinya files
# Updates Chinese translations to add text segmentation
# Scores all translations using BLEU, BERTscore and COMET if langauge covered 
...
if __name__ == '__main__':
    ...
    print('Microsoft complete.  Starting to translate with Google.')
